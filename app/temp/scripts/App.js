...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // JS for Overlay aka Modal, aka light box
...
var StickyHeader = function () {
  function StickyHeader() {
    ...
    this.pageSections = (0, _jquery2.default)(".page-section"); // all CSS class="page-section"
    this.headerLinks = (0, _jquery2.default)(".primary-nav a"); // list of all primary-nav elements  anchors
